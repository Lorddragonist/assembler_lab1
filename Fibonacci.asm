...
main:
    ...
    syscall
    move $a1, $v0 # Mover el numero leído a $a1 para guardar el total de elementos

    # Verificar si el numero es válido para proceder
    li $t0, 0 # Primer numero de Fibonacci
    li $t1, 1 # Segundo numero de Fibonacci
    li $t2, 0 # Índice del bucle

    loop_cond:
        bge $t2, $a1, end_loop # Si el índice es mayor o igual al numero de elementos, terminar
